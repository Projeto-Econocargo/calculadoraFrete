...
const trt = require('./src/modules/Trt');
let subtotal = calcularAdvalorem + calculaGris + calculaPedagio + calculaTas + calculaAdmrodo + calculaAdmTrans + calculaTsb + seguroFluvial + tarifaPortuaria + taxaBalsa + trf + emex + trt;
